...
<head>
 ...
 <link href="css/templatemo-pod-talk.css" rel="stylesheet">
    <style>
        .navbar{
            background-image:url("images\templatemo-wave-header.jpg");
        }
    </style>
</head>
...
<body>
    ...
    <div class="container">
        ...
        <asp:Panel runat="server" CssClass="collapse navbar-collapse" ID="navbarNav">
         <%--   <ul class="navbar-nav ms-lg-auto" display="hidden">
                <li class="nav-item">
            ...
            <asp:HyperLink runat="server" NavigateUrl="#section_3" CssClass="btn custom-btn custom-border-btn smoothscroll ms-4">LOGOUT</asp:HyperLink>
        </asp:Panel>
    </div>
</asp:Panel>
